...
# Local imports...
from ..views import log_in_view, log_out_view, profile_view, profile_edit_view, sign_up_view
...
class SignUpViewTest(TestCase):
    ...
    def test_saves_form_and_logs_in_user_for_valid_data(self, mock_login, mock_sign_up_form):
        ...
        mock_form.save.return_value = Mock(email='parentj@eab.com')
...
class LogInViewTest(TestCase):
    ...
    def test_logs_in_user_for_valid_data(self, mock_login, mock_log_in_form):
        mock_form = mock_log_in_form.return_value
        mock_form.is_valid.return_value = True
        mock_form.get_user.return_value = Mock(email='parentj@eab.com')
...
class ProfileViewTest(TestCase):
    ...
    def test_profile_view_renders_profile_template(self):
        ...
        with self.assertTemplateUsed(template_name='accounts/profile.html'):
...
class ProfileEditViewTest(TestCase):
    ...
    def test_profile_edit_view_renders_profile_edit_template(self):
        ...
        with self.assertTemplateUsed(template_name='accounts/profile_edit.html'):
            profile_edit_view(request)
